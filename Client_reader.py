...
# Form implementation generated from reading ui file 'Client_reader.ui'
#
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "图书管理系统-读者"))
        self.label.setText(_translate("MainWindow", "明文/密文展示"))
        self.pushButton.setText(_translate("MainWindow", "书籍查询"))
        self.pushButton_2.setText(_translate("MainWindow", "信息修改"))
        self.pushButton_3.setText(_translate("MainWindow", "书籍借还"))
